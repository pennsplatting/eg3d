...
python3 eg3d/train_debug.py --outdir=~v2/training-runs --cfg=ffhq --data=/home/xuyimeng/Repo/eg3d/FFHQ_subset_6_finished.zip \
  --gpus=1 --batch=4 --gamma=1 --gen_pose_cond=True --snap=5
